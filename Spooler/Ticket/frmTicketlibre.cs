    ...
    public partial class frmTicketlibre : Form
    {
        ...
        public void PrintTicket(Spooler.Models.Document _documentToPrint, string _printerName)
        {
            try
            {
                ...
                byte[] pdfBytes = reportViewer1.LocalReport.Render("PDF", deviceInfo, out contentType, out encoding,
